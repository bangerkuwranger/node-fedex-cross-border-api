...
class XmlOutputObject {
  ...
  getXmlString() {
    ...
    for (let i = 0; i < xmlOutputObjectValues.length; i++) {
      ...
      if (this.hasOwnProperty(xmlOutputObjectValues[i]) && 'function' != typeof xmlOutputObjectValues[i] && 'xmlObjectName' !== xmlOutputObjectValues[i]) {
...
class ExportHub {
  ...
  constructor(facilityCode, countryCode) {
    ...
    this.country = ('string' != typeof countryCode || null === countryCode) ? null : countryCode.substring(0, 2).toUpperCase();
...
class ProductInfoDat extends XmlOutputObject {
  ...
  constructor(id, description, price, currency, exportHub, origin, itemInformation, optionalArgs) {
    ...
    if ('string' != typeof id || 'string' != typeof description || 'number' != typeof price || 'string' != typeof currency || 'string' != typeof exportHub || 'string' != typeof origin || 'object' != typeof itemInformation) {
      ...
      this.countryOfOrigin = ('string' == typeof origin && isValidCountry(origin)) ? origin : 'US';
      var itemInfoArray = [
        ('undefined' == typeof itemInformation.l) ? null : itemInformation.l,
        ('undefined' == typeof itemInformation.w) ? null : itemInformation.w,
        ('undefined' == typeof itemInformation.h) ? null : itemInformation.h,
        ('undefined' == typeof itemInformation.wt) ? null : itemInformation.wt
      ];
      this.itemInformation = ('object' == typeof itemInformation && itemInformation instanceof CartonsDat) ? itemInformation : new CartonsDat(...itemInfoArray);
...
class SkuStatusDat extends XmlOutputObject {
  ...
  constructor(productID, skuHsCode, productStatus) {
    ...
    super('SkuStatusDat');
    this.productID = ('string' == typeof productID) ? productID : '';
...
function xmlObjectNodeArray(nodeObject, ObjectConstructor) {
  ...
  } else if ('function' == typeof ObjectConstructor) {
...
function setPropertyIf(sourceObj, targetObj, propName, testVal = 'exists', defaultVal = null) {
  ...
  let testMap = {
    ...
    string: function testString(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName]) {
    ...
    csvStringCountry: function testString(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName]) {
        ...
        if (-1 === sourceObj[propName].indexOf(',')) {
          ...
          var validCountries = [];
          var countriesArray = optionalArgs.licenseFlag.split(',');
          for (let i = 0; i < licenseCountries.length; i++) {
    ...
    string10: function testString(sourceObj, targetObj, propName, defaultVal, useDefault) {
    ...
    string15: function testString(sourceObj, targetObj, propName, defaultVal, useDefault) {
    ...
    string50: function testString(sourceObj, targetObj, propName, defaultVal, useDefault) {
    ...
    string250: function testString(sourceObj, targetObj, propName, defaultVal, useDefault) {
    ...
    'int': function testInt(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('number' == typeof sourceObj[propName] && !(isNaN(parseInt(sourceObj[propName])))) {
    ...
    intBool: function testInt(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('number' == typeof sourceObj[propName] && !(isNaN(parseInt(sourceObj[propName]))) && (0 === parseInt(sourceObj[propName]) || 1 === parseInt(sourceObj[propName]))) {

        targetObj[propName] = parseInt(sourceObj[propName]);
        return targetObj[propName];

      }
      else if (useDefault && (0 === parseInt(defaultVal) || 1 === parseInt(defaultVal))) {
    ...
    intRange0to3: function testIntRange0to3(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('number' == typeof sourceObj[propName] && !(isNaN(parseInt(sourceObj[propName]))) && -1 < parseInt(sourceObj[propName]) && 4 > parseInt(sourceObj[propName])) {

        targetObj[propName] = parseInt(sourceObj[propName]);
        return targetObj[propName];

      }
      else if (useDefault && -1 < parseInt(sourceObj[propName]) && 4 > parseInt(sourceObj[propName])) {
    ...
    'float': function testFloat(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('number' == typeof sourceObj[propName] && !(isNaN(parseFloat(sourceObj[propName])))) {
    ...
    'object': function testObject(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('object'== typeof sourceObj[propName]) {
    ...
    'array': function testArray(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('object'== typeof sourceObj[propName] && Array.isArray(sourceObj[propName])) {
    ...
    'nonEmptyArray': function testNonEmptyArray(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('object'== typeof sourceObj[propName] && Array.isArray(sourceObj[propName]) && 0 < itemsArray.length) {
    ...
    validLanguage: function testValidLanguage(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName] && isValidLanguage(sourceObj[propName].trim().toLowerCase().substring(0, 2))) {
    ...
    validCurrency: function testValidCurrency(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName] && isValidCurrency(sourceObj[propName].trim().toLowerCase().substring(0, 3))) {

        targetObj[propName] = sourceObj[propName].trim().toLowerCase().substring(0, 3);
        return targetObj[propName];

      }
      else if (useDefault) {

        targetObj[propName] = defaultVal.trim().toLowerCase().substring(0, 3);
        return targetObj[propName];
    ...
    validCountry: function testValidCountry(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName] && isValidCountry(sourceObj[propName].trim().toLowerCase().substring(0, 2))) {
    ...
    carrierCode: function testCarrierCode(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      else if ('number' == typeof sourceObj[propName] && !(isNaN(parseInt(sourceObj[propName]))) && -1 < parseInt(sourceObj[propName]) && 4 > parseInt(sourceObj[propName])) {
    ...
    stringYOrN: function stringYOrN(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName] && ('Y' === sourceObj[propName].trim().toUpperCase().substring(0, 1) || 'N' === sourceObj[propName].trim().toUpperCase().substring(0, 1))) {
    ...
    productInfo(itemsArray) {
      ...
      if ('object' == typeof itemsArray && Array.isArray(itemsArray) && 0 < itemsArray.length) {
        ...
        .then((resultObject) => {
          ...
          var justTheBody = 'undefined' == typeof resultObject.body ? false : resultObject.body['SOAP-ENV:Envelope']['SOAP-ENV:Body']['ns1:ConnectProductInfoResponse'].return;
          if (justTheBody) {
            delete justTheBody['xsi:type'];
            var bodyError = ('undefined' != typeof justTheBody.error) ? xmlNodeValue(justTheBody.error) : 0;
            if (bodyError != 0) {
