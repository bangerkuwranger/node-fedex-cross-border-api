...
function setPropertyIf(sourceObj, targetObj, propName, testVal = 'exists', defaultVal = null) {
  ...
  console.log(typeof sourceObj[propName] + ' - ' + propName);
  let useDefault = ('undefined' != typeof defaultVal && null !== defaultVal);
  let testMap = {
    ...
    boolean: function testBoolean(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('boolean' == typeof sourceObj[propName]) {
        ...
        targetObj[propName] = (defaultVal && 'false' !== defaultVal && 0 !== defaultVal && '0' !== defaultVal) ? true : false;
        return targetObj[propName];
    ...
    validCurrency: function testValidCurrency(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName] && isValidCurrency(sourceObj[propName].trim().toUpperCase().substring(0, 3))) {
    ...
    validCountry: function testValidCountry(sourceObj, targetObj, propName, defaultVal, useDefault) {
      ...
      if ('string' == typeof sourceObj[propName] && isValidCountry(sourceObj[propName].trim().toUpperCase().substring(0, 2))) {
